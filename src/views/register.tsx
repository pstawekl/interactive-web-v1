        ...
        if (isMounted) {
            if (typeof window !== 'undefined') {
                ...
                if (role) {
                    ...
                    localStorage.setItem('register:role', role);
                } else {
                    const roleFromStorage = localStorage.getItem('register:role');
    ...
    return <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-screen">
        <div className="flex items-center justify-center">
            <div className="p-8 rounded shadow-lg">
                <h1 className="text-2xl font-bold mb-4">Zarejestruj się jako {loginTypeName}</h1>
                <form className="flex flex-col gap-4">
                    ...
                    <button type="submit" className="bg-blue-500 text-white p-2 rounded">Zarejestruj</button>
                </form>
            </div>
        </div>
        <div>
